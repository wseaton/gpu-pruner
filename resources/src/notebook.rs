...
// kopium command: kopium -f /tmp/notebooks-crd.yaml --schema=derived --api-version=v1
...
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct NotebookTemplateSpecContainersLivenessProbeGrpc {
    pub port: i32,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct NotebookTemplateSpecContainersReadinessProbeGrpc {
    pub port: i32,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub service: Option<String>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct NotebookTemplateSpecContainersStartupProbeGrpc {
    pub port: i32,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub service: Option<String>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct NotebookTemplateSpecEphemeralContainersLivenessProbeGrpc {
    pub port: i32,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub service: Option<String>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct NotebookTemplateSpecEphemeralContainersReadinessProbeGrpc {
    pub port: i32,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub service: Option<String>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct NotebookTemplateSpecEphemeralContainersStartupProbeGrpc {
    pub port: i32,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub service: Option<String>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct NotebookTemplateSpecInitContainersLivenessProbeGrpc {
    pub port: i32,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub service: Option<String>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct NotebookTemplateSpecInitContainersReadinessProbeGrpc {
    pub port: i32,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub service: Option<String>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct NotebookTemplateSpecInitContainersStartupProbeGrpc {
    pub port: i32,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub service: Option<String>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct NotebookTemplateSpecOs {
    pub name: String,
}
...
pub struct NotebookStatus {
    ...
    #[serde(rename = "containerState")]
    pub container_state: NotebookStatusContainerState,
    #[serde(rename = "readyReplicas")]
    pub ready_replicas: i32,
}

#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct NotebookStatusContainerState {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub running: Option<NotebookStatusContainerStateRunning>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub terminated: Option<NotebookStatusContainerStateTerminated>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub waiting: Option<NotebookStatusContainerStateWaiting>,
}

#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct NotebookStatusContainerStateRunning {
...
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct NotebookStatusContainerStateWaiting {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub message: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub reason: Option<String>,
